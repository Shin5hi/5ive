...
## 2025-05-15 - User Control in Notifications
**Learning:** Auto-dismissing toasts can frustrate users if they miss the content or want to clear the screen immediately.
**Action:** Always include a dismiss button in toast notifications to respect user control and pace.
